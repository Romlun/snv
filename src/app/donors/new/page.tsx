...
export default function NewDonorPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    stage: "New contact" as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor",
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input
                ...
                value={formData.name}
                onChange={e => setFormData({ ...formData, name: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
              />
            </div>
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={e => setFormData({ ...formData, email: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
              />
            </div>
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={e => setFormData({ ...formData, phone: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
              />
            </div>
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={e => setFormData({ ...formData, stage: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor" })}
              >
                <option>New contact</option>
                <option>First conversation</option>
                <option>Interested</option>
                <option>Active donor</option>
                <option>Monthly supporter</option>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={e => setFormData({ ...formData, assigned_staff_id: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
              >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={e => setFormData({ ...formData, church_id: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
              >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={e => setFormData({ ...formData, notes: e.target.value as "New contact" | "First conversation" | "Interested" | "Active donor" | "Monthly supporter" | "Major donor"})}
            />
          </div>
          <button
            type="submit"
